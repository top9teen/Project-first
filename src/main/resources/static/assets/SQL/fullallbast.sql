...
-- Dumping structure for table projectdb2.amount
CREATE TABLE IF NOT EXISTS `amount` (
  `am_email` varchar(255) DEFAULT NULL,
  `am_money` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='จำนวนเงิน';

-- Dumping data for table projectdb2.amount: ~6 rows (approximately)
/*!40000 ALTER TABLE `amount` DISABLE KEYS */;
INSERT INTO `amount` (`am_email`, `am_money`) VALUES
	('sad@dsa.com', 556),
	('dsad@dsaadsad.com', 0),
	('kasikorn', 888),
	('krungsri', 0),
...
-- Dumping structure for table projectdb2.money
CREATE TABLE IF NOT EXISTS `money` (
  `mo_idcradmoney` varchar(15) DEFAULT '0',
  `mo_money` int(11) DEFAULT '0',
  `mo_staus` varchar(1) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเงิน';

-- Dumping data for table projectdb2.money: ~8 rows (approximately)
/*!40000 ALTER TABLE `money` DISABLE KEYS */;
INSERT INTO `money` (`mo_idcradmoney`, `mo_money`, `mo_staus`) VALUES
	('12345678912345', 3000, '1'),
	('020795489236596', 500, '1'),
	('11111111111111', 555, '1'),
	('40750880010445', 500, '2'),
	('73113271516662', 10, '1'),
	('74132564189453', 445, '2'),
	('88886578399124', 444, '2'),
	('72250029023923', 50, '2');
...
CREATE TABLE IF NOT EXISTS `msgadmin` (
  ...
  `ms_email` varchar(255) DEFAULT NULL,
  `ms_staus` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`ms_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='ข้อความเเอดมิน';

-- Dumping data for table projectdb2.msgadmin: ~7 rows (approximately)
/*!40000 ALTER TABLE `msgadmin` DISABLE KEYS */;
INSERT INTO `msgadmin` (`ms_id`, `ms_name`, `ms_msghard`, `ms_msgbody`, `ms_date`, `ms_email`, `ms_staus`) VALUES
	(4, 'kasikorn', 'saddasdasa', 'dsaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '2018-05-23', 'gfg', '2'),
	(5, 'kasikorn', 'cczdsfsf', 'fdsfsdfsfsfdsfsf', '2018-05-23', 'fdgdf', '1'),
	(6, 'kasikorn', 'dsfsdfsdf', 'sdfsdfsfdsfs', '2018-06-22', 'admin@hotmail.com', '1'),
	(7, 'test3@hotmail.com', 'dadasd', 'adasdadasdad', '2018-06-22', 'admin@hotmail.com', '2'),
	(8, 'admin@hotmail.com', 'dasdsadas', 'asdasdsadsadsadsadsaddasdsad', '2018-06-22', 'dsad@dsaadsad.com', '1'),
	(9, 'dsad@dsaadsad.com', 'เติมเงืน', '1200 บาท', '2018-06-23', 'admin@hotmail.com', '2'),
	(10, 'admin@hotmail.com', 'บัตร', '88886578399124', '2018-06-23', 'dsad@dsaadsad.com', '1'),
	(11, 'kasikorn@hotmail.com', 'ส่ง งวดรถ', 'กฟหกหฟก', '2018-06-24', 'sad@dsa.com', '1');
/*!40000 ALTER TABLE `msgadmin` ENABLE KEYS */;

-- Dumping structure for table projectdb2.porepaidhistory
CREATE TABLE IF NOT EXISTS `porepaidhistory` (
  `ph_email` varchar(255) DEFAULT NULL,
  `ph_idcard` varchar(50) DEFAULT NULL,
  `ph_money` varchar(50) DEFAULT NULL,
  `ph_date` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ประวัติการเติมเงิน ';

-- Dumping data for table projectdb2.porepaidhistory: ~1 rows (approximately)
/*!40000 ALTER TABLE `porepaidhistory` DISABLE KEYS */;
INSERT INTO `porepaidhistory` (`ph_email`, `ph_idcard`, `ph_money`, `ph_date`) VALUES
	('sad@dsa.com', '40750880010445', '500', '2018-06-23'),
	('sad@dsa.com', '74132564189453', '445', '2018-06-24');
/*!40000 ALTER TABLE `porepaidhistory` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `registerall` (
  ...
  `reg_firstname` varchar(70) DEFAULT NULL,
  ...
  `reg_salary` varchar(50) DEFAULT NULL COMMENT 'เงินเดือน',
  `reg_lesslimit` varchar(50) DEFAULT NULL COMMENT 'เงินที่ต้องการ',
  ...
  `reg_roleuser` varchar(1) DEFAULT NULL COMMENT 'เข้าถึงของพนักงาน',
  `reg_statusmember` varchar(1) DEFAULT NULL,
  `reg_lat` varchar(50) DEFAULT NULL,
  `reg_log` varchar(50) DEFAULT NULL,
  `reg_lessdaytomy` varchar(50) DEFAULT NULL,
  `reg_readtext` varchar(1) DEFAULT NULL COMMENT 'อ่าน/ไม่อ่าน',
  `reg_period` int(11) DEFAULT NULL COMMENT 'งวด',
  PRIMARY KEY (`reg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='ใบสมัครสินเชื่อรถที่รอการ อนุมัติ';

-- Dumping data for table projectdb2.registerall: ~11 rows (approximately)
/*!40000 ALTER TABLE `registerall` DISABLE KEYS */;
INSERT INTO `registerall` (`reg_id`, `reg_bankname`, `reg_firstname`, `reg_amphur`, `reg_district`, `reg_moban`, `reg_lastname`, `reg_age`, `reg_province`, `reg_telephone`, `reg_idcard`, `reg_email`, `reg_carmodel`, `reg_carmake`, `reg_totalincome`, `reg_salary`, `reg_lesslimit`, `reg_lessday`, `reg_imgfront`, `reg_imgback`, `reg_imgleft`, `reg_imgright`, `reg_date`, `reg_roleuser`, `reg_statusmember`, `reg_lat`, `reg_log`, `reg_lessdaytomy`, `reg_readtext`, `reg_period`) VALUES
	(30, 'kasikorn', 'test1', 'หนองเสือ   ', 'บึงชำอ้อ   ', '85/1', 'test2', 70, 'ปทุมธานี   ', '656565656', '55556565', 'rtretretet', 'CAPTIVA 2.4 LS', 'CHEVROLET', '2016', '100', '8000', '12', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', '2018-06-11', '1', '2', '10', '10', '12', '1', NULL),
	(31, 'kasikorn', 'top', 'บ้านหมอ   ', 'โคกใหญ่   ', '7575', 'taaa', 25, 'สระบุรี', '7575755', '57757575575', 'fdsfdsfdsfdsf', 'ECO SPORT 1.5L TITANIUM A/T (SVP PACKAGE) MPBSXXMX', 'FORD', '2016', '55', '5000', '10', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', '2018-06-14', '2', '5', '10', '10', '12', '2', NULL),
	(32, 'kasikorn', 'top', 'ลำลูกกา   ', 'บึงคำพร้อย   ', '555', 'taaa', 26, 'ปทุมธานี   ', '6565656', '656565', 'adasdasd', '118 I Sport', 'BMW', '2016', '5656', '500', '12', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', '2018-06-14', '2', '1', '14.995494199999998', '103.1105109', '12', '1', NULL),
	(33, 'kasikorn', 'test1', 'วิเศษชัยชาญ   ', 'สาวร้องไห้   ', '5555', 'test2', 55, 'อ่างทอง   ', '5555', '55555', 'ghfhfghfgh', 'CAPTIVA 2.4 LS', 'CHEVROLET', '2016', '2222', '55555', '24', 'assets/img/imgreg/logo.jpg', 'assets/img/imgreg/logo.jpg', 'assets/img/imgreg/logo.jpg', 'assets/img/imgreg/logo.jpg', '2018-06-14', '1', '1', '14.9954984', '103.11054019999999', '24', '1', NULL),
	(34, 'kasikorn', 'test1', 'หนองเสือ   ', 'บึงบอน   ', '4444', 'test2', 44, 'ปทุมธานี   ', '42424424', '242424242', 'efdsfsdfdsfds', 'CAPTIVA 2.4 LTZ AWD (NAVI) (MMMCB2611BH) White', 'CHEVROLET', '2016', '5555', '500000', '36', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', '2018-06-19', '1', '4', '14.9914533', '103.09993019999999', '36', '2', NULL),
	(35, 'krungsri', 'dasdsad', 'บางกรวย   ', 'บางขนุน   ', '4545', 'sadsadasd', 55, 'นนทบุรี   ', '5454545', '5454545', 'dsad@dsaadsad.com', 'A250 2.0 CGI (WDD176044)', 'BENZ', '2016', '555', '444', '39', 'assets/img/imgreg/DFD1.2.jpg', 'assets/img/imgreg/5.login.jpg', 'assets/img/imgreg/5.login.jpg', 'assets/img/imgreg/5.login.jpg', '2018-06-22', '1', '1', '14.9954597', '103.1104477', '39', '1', NULL),
	(36, 'thanachart', 'dasdsad', 'นครหลวง   ', 'บ้านชุ้ง   ', '5555', 'sadsadasd', 55, 'พระนครศรีอยุธยา   ', '65656', '6565656', 'dsad@dsaadsad.com', 'CAPTIVA 2.4 LS', 'CHEVROLET', '2015', '5556', '50000', '12', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', '2018-06-22', '1', '1', '14.9954807', '103.1104939', '12', '1', NULL),
	(37, 'kasikorn', 'dasdsad', 'ไทรน้อย   ', 'ไทรใหญ่   ', '6566556', 'sadsadasd', 50, 'นนทบุรี   ', '656565656', '6565656', 'dsad@dsaadsad.com', '118 I M Sport (F20) (MMFR540X05) B38B15A', 'BMW', '2016', '65656556', '50000', '12', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', '2018-06-22', '1', '1', '14.9914597', '103.0999003', '12', '1', NULL),
	(38, 'scbeasy', 'sadsad', 'นครหลวง   ', 'บางระกำ   ', '555', 'sadasd', 50, 'พระนครศรีอยุธยา   ', '56665', '56566556', 'sad@dsa.com', 'FIESTA 1.0 ECOBOOT A/T 4DR MNBSXXARJ8', 'FORD', '2016', '56665656', '50000', '24', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', '2018-06-23', '1', '1', '14.9954817', '103.1104859', '24', '1', NULL),
	(40, 'krungsri', 'sadsad', 'บางใหญ่   ', 'บางแม่นาง   ', '45454', 'sadasd', 50, 'นนทบุรี   ', '4545', '54545', 'sad@dsa.com', 'A250 AMG SPORT', 'BENZ', '2016', '54545', '5000', '12', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/Context Diagram.jpg', '2018-06-23', '1', '1', '14.995482299999999', '103.11053849999999', '12', '1', 444),
	(41, 'kasikorn', 'sadsad', 'บางกรวย   ', 'บางสีทอง   ', '444', 'sadasd', 44, 'นนทบุรี   ', '4444', '4444', 'sad@dsa.com', 'A250 AMG SPORT', 'BENZ', '2017', '4444', '5000', '12', 'assets/img/imgreg/DFD1.3.jpg', 'assets/img/imgreg/DFD1.3.jpg', 'assets/img/imgreg/DFD1.3.jpg', 'assets/img/imgreg/DFD1.3.jpg', '2018-06-24', '2', '5', '14.9954879', '103.11049039999999', '10', '2', 444);
...
CREATE TABLE IF NOT EXISTS `regname` (
  ...
  `na_amphur` varchar(255) DEFAULT NULL,
  `na_district` varchar(255) DEFAULT NULL,
  `na_moban` varchar(255) DEFAULT NULL,
  `na_lat` varchar(255) DEFAULT NULL,
  `na_log` int(11) DEFAULT NULL,
  PRIMARY KEY (`na_id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8;

-- Dumping data for table projectdb2.regname: ~3 rows (approximately)
/*!40000 ALTER TABLE `regname` DISABLE KEYS */;
INSERT INTO `regname` (`na_id`, `na_bankname`, `na_firstname`, `na_lastname`, `na_age`, `na_province`, `na_telephone`, `na_idcard`, `na_email`, `na_carmodel`, `na_carmake`, `na_totalincome`, `na_salary`, `na_lesslimit`, `na_lessday`, `na_imgfront`, `na_imgback`, `na_imgleft`, `na_imgright`, `na_date`, `na_idrole`, `na_amphur`, `na_district`, `na_moban`, `na_lat`, `na_log`) VALUES
	(22, 'kasikorn', 'อ้อ่าอ', 'เีเส้าเาเอ้เ', 66, 'ตรัง', 664485454, 45451515, 'ดัะดีด่ัเ้รน่นยา', 'NEW D-MAX HI-LANDER CAB4 1.9 Z Prestiqe', 'ISUZU', '2016', '45451', '400000', '36', 'assets/img/imgreg/Case and Effect Diagram .jpg', 'assets/img/imgreg/Context Diagram.jpg', 'assets/img/imgreg/แผนผังระบบงาน (System Flowchart.jpg', 'assets/img/imgreg/java.jpg', '2018-05-23', 6, NULL, NULL, NULL, NULL, NULL),
	(23, 'kasikorn', 'gtyrty', 'dfsdfdf', 54, 'กาญจนบุรี', 565656, 565656, 'ytyrtytyryt', 'FIESTA 1.5L A/T Sport 4DR', 'FORD', '2017', '5555', '200000', '24', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', '2018-05-23', 7, NULL, NULL, NULL, NULL, NULL),
	(24, 'scbeasy', 'แกดกดหด', 'กฟกฟก', 22, 'ชัยนาท', 555555555, 555555555, 'กกหฟฟกฟก', 'CITY 1.5 S M/T (MRHGM6520)', 'HONDA', '2016', '55555', '500000', '36', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', '2018-06-01', 13, NULL, NULL, NULL, NULL, NULL);
...
-- Dumping structure for table projectdb2.transfermoney
CREATE TABLE IF NOT EXISTS `transfermoney` (
  `tr_emailuser` varchar(255) DEFAULT NULL,
  `tr_emailmember` varchar(255) DEFAULT NULL,
  `tr_monney` varchar(255) DEFAULT NULL,
  `tr_date` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='โอนเงิน';

-- Dumping data for table projectdb2.transfermoney: ~0 rows (approximately)
...
INSERT INTO `transfermoney` (`tr_emailuser`, `tr_emailmember`, `tr_monney`, `tr_date`) VALUES
	('sad@dsa.com', 'kasikorn', '444', '2018-06-24');
...
CREATE TABLE IF NOT EXISTS `userall` (
  ...
  `us_rights` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`us_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='รหัสเข้าทั้งหมด';

-- Dumping data for table projectdb2.userall: ~13 rows (approximately)
/*!40000 ALTER TABLE `userall` DISABLE KEYS */;
INSERT INTO `userall` (`us_id`, `us_fname`, `us_lname`, `us_address`, `us_role`, `us_createdate`, `us_username`, `us_password`, `us_img`, `us_rights`) VALUES
	(1, 'top', 'tan', 'dsada', '1', '2018-05-03', 'admin@hotmail.com', '1234', 'a', 'top'),
	(2, 'kasikorn', 'kasikorn', 'kasikorn', '2', '2018-05-03', 'kasikorn@hotmail.com', '1234', 'assets/img/imgpro/kasikorn.jpg', 'kasikorn'),
	(3, 'krungsri', 'krungsri', 'krungsri', '2', '2018-05-18', 'krungsri@hotmail.com', '1234', 'assets/img/imgpro/krungsri.jpg', 'krungsri'),
	(4, 'scbeasy', 'scbeasy', 'scbeasy', '2', '2018-05-18', 'scbeasy@hotmail.com', '1234', 'assets/img/imgpro/scbeasy.jpg', 'scbeasy'),
	(5, 'thanachart', 'thanachart', 'thanachart', '2', '2018-05-18', 'thanachart@hotmail.com', '1234', 'assets/img/imgpro/thanachart.jpg', 'thanachart'),
	(6, 'top', 'tan', 'toptan', '5', '2018-06-02', 'toptan@hotmail.com', '1234', 'assets/img/imgpro/scbesy.jpg', 'top'),
	(7, 'test1', 'test2', 'NO ADDRESS', '5', '2018-06-02', 'tes3@hotmail.com', '1234', 'assets/img/imgpro/noname.png', 'test1'),
	(8, 'test4', 'test4', 'NO ADDRESS', '5', '2018-06-06', 'test4@hotmail.com', '1234', 'assets/img/imgpro/noname.png', 'test4'),
	(9, 'test5', 'test5', 'NO ADDRESS', '5', '2018-06-06', 'test5@hotmail.com', '1234', 'assets/img/imgpro/noname.png', 'test5'),
	(10, 'top', 'taaa', 'NO ADDRESS', '5', '2018-06-14', 'top123@hotmail.com', '1234', 'assets/img/imgpro/noname.png', 'top'),
	(12, 'testbank3', 'testbank3', 'NO ADDRESS', '3', '2018-06-19', 'test3@hotmail.com', '1234', 'assets/img/imgpro/kasikorn.jpg', 'kasikorn'),
	(13, 'testbank4', 'testbank4', 'testbank4', '4', '2018-06-20', 'testbank4@hotmail.com', '1234', 'assets/img/imgpro/kasikorn.jpg', 'kasikorn'),
	(14, 'dasdsadsd', 'asdasdasdsad', 'NO ADDRESS', '3', '2018-06-20', 'vvvv@vv.com', '1234', 'assets/img/imgpro/kasikorn.jpg', 'kasikorn'),
	(15, 'dasdasdadasdsad', 'adsdsssssss', 'NO ADDRESS', '4', '2018-06-20', 'ddd@dd.com', '1234', 'assets/img/imgpro/krungsri.jpg', 'krungsri'),
	(16, 'dasdsad', 'sadsadasd', 'NO ADDRESS', '5', '2018-06-22', 'dsad@dsaadsad.com', '1234', 'assets/img/imgpro/noname.png', 'dsad@dsaadsad.com'),
	(17, 'sadsad', 'sadasd', 'NO ADDRESS', '5', '2018-06-22', 'sad@dsa.com', '1234', 'assets/img/imgpro/noname.png', 'sad@dsa.com');
