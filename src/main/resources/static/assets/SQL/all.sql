...
-- Dumping data for table projectdb2.amount: ~1 rows (approximately)
...
INSERT INTO `money` (`mo_idcradmoney`, `mo_money`, `mo_staus`) VALUES
	...
	('40750880010445', 500, '1'),
	('73113271516662', 10, '1'),
	('74132564189453', 445, '1'),
	('88886578399124', 444, '1'),
	('72250029023923', 50, '2');
...
CREATE TABLE IF NOT EXISTS `msgadmin` (
  ...
  PRIMARY KEY (`ms_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='ข้อความเเอดมิน';

-- Dumping data for table projectdb2.msgadmin: ~5 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `registerall` (
  ...
  PRIMARY KEY (`reg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='ใบสมัครสินเชื่อรถที่รอการ อนุมัติ';

-- Dumping data for table projectdb2.registerall: ~8 rows (approximately)
...
INSERT INTO `registerall` (`reg_id`, `reg_bankname`, `reg_firstname`, `reg_amphur`, `reg_district`, `reg_moban`, `reg_lastname`, `reg_age`, `reg_province`, `reg_telephone`, `reg_idcard`, `reg_email`, `reg_carmodel`, `reg_carmake`, `reg_totalincome`, `reg_salary`, `reg_lesslimit`, `reg_lessday`, `reg_imgfront`, `reg_imgback`, `reg_imgleft`, `reg_imgright`, `reg_date`, `reg_roleuser`, `reg_statusmember`, `reg_lat`, `reg_log`, `reg_lessdaytomy`, `reg_readtext`) VALUES
	(30, 'kasikorn', 'test1', 'หนองเสือ   ', 'บึงชำอ้อ   ', '85/1', 'test2', 70, 'ปทุมธานี   ', '656565656', '55556565', 'rtretretet', 'CAPTIVA 2.4 LS', 'CHEVROLET', '2016', '100', '8000', '12', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', 'assets/img/imgreg/no_image.jpg', '2018-06-11', '1', '2', '10', '10', '12', '1'),
	(31, 'kasikorn', 'top', 'บ้านหมอ   ', 'โคกใหญ่   ', '7575', 'taaa', 25, 'สระบุรี', '7575755', '57757575575', 'fdsfdsfdsfdsf', 'ECO SPORT 1.5L TITANIUM A/T (SVP PACKAGE) MPBSXXMX', 'FORD', '2016', '55', '5000', '10', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', '2018-06-14', '2', '5', '10', '10', '12', '2'),
	(32, 'kasikorn', 'top', 'ลำลูกกา   ', 'บึงคำพร้อย   ', '555', 'taaa', 26, 'ปทุมธานี   ', '6565656', '656565', 'adasdasd', '118 I Sport', 'BMW', '2016', '5656', '500', '12', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', 'assets/img/imgreg/car1.png', '2018-06-14', '2', '1', '14.995494199999998', '103.1105109', '12', '1'),
	(33, 'kasikorn', 'test1', 'วิเศษชัยชาญ   ', 'สาวร้องไห้   ', '5555', 'test2', 55, 'อ่างทอง   ', '5555', '55555', 'ghfhfghfgh', 'CAPTIVA 2.4 LS', 'CHEVROLET', '2016', '2222', '55555', '24', 'assets/img/imgreg/logo.jpg', 'assets/img/imgreg/logo.jpg', 'assets/img/imgreg/logo.jpg', 'assets/img/imgreg/logo.jpg', '2018-06-14', '1', '1', '14.9954984', '103.11054019999999', '24', '1'),
	...
	(35, 'krungsri', 'dasdsad', 'บางกรวย   ', 'บางขนุน   ', '4545', 'sadsadasd', 55, 'นนทบุรี   ', '5454545', '5454545', 'dsad@dsaadsad.com', 'A250 2.0 CGI (WDD176044)', 'BENZ', '2016', '555', '444', '12', 'assets/img/imgreg/DFD1.2.jpg', 'assets/img/imgreg/5.login.jpg', 'assets/img/imgreg/5.login.jpg', 'assets/img/imgreg/5.login.jpg', '2018-06-22', '1', '1', '14.9954597', '103.1104477', '12', '1'),
...
-- Dumping data for table projectdb2.userall: ~16 rows (approximately)
