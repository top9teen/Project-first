	...
	<div class="row">
		<div class="col-md-10">
			<form name="welcome" action="." method="post">
				...
				<br> <input type="hidden" name="regid" id="regid">
				<div class=" form-group row">
					...
					<div align="right" class="col-xs-4">
						...
						<input id="myInput" type="text" placeholder="Search...."
							...
							<span style="font-size: 15px;"> จำนวนเงินของท่าน :<input id="test2" type="text"disabled="disabled" value="<%=beandsw.getAmMoney() %>"/> บาท</span>
					</div>
				</div>
				...
				<table class="table table-bordered">
					...
					<thead>
						<tr>
							...
							<th class="text-center">งวดทีต้องจ่าย</th>
					...
					<tbody id="myTable">
						...
						<tr class="text-center">
							...
							<td><a onclick="gotoUpdate('<%=list.get(i).getRegId()%>')"><span
								...
								onclick="gotoUpdate45('<%=list.get(i).getRegId()%>')"><span
									class="glyphicon glyphicon-search">  </span>จ่ายงงวด</a></td>
...
<script type="text/javascript">
	...
	function gotoUpdate45(filter) {
		document.getElementById("regid").value = filter;
		document.welcome.action = "gotoprind";
		document.welcome.submit();
	}
