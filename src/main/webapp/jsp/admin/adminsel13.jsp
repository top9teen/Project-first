...
<%@page import="java.util.List"%>
<%
	List<TransfermoneyBean> list1 = null;
	List<PorepaidhistoryBean> list2 = null;
%>
<%
	list1 = (List<TransfermoneyBean>) request.getSession().getAttribute("list1");
	list2 = (List<PorepaidhistoryBean>) request.getSession().getAttribute("list2");
%>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<input type="button" name="btn" id="btn"
									value="ดูประวัติการเติมบัตร" class="btn btn-info"
									onclick="toggle1()"> <br> <br> 
									<input type="button" name="btn" id="btn" value="ดูประวัติการโอน" class="btn btn-info" onclick="toggle2()">
							</div>
							<div class="col-md-4"></div>
						</div>
						<div class=" form-group" id="display1" style="display: none;">
							<h2 align="center">ดูประวัติการเติมบัตร</h2>
							...
							<table class="table table-bordered">
								...
								<tbody id="myTable">
									...
									<tr class="text-center">
										...
										<td><%=i + 1%></td>
										<td><%=list2.get(i).getPh_email()%></td>
										<td><%=list2.get(i).getPh_idcard()%></td>
										<td><%=list2.get(i).getPh_money()%></td>
										<td><%=list2.get(i).getPh_date()%></td>
						...
						<div class=" form-group" id="display2" style="display: none;">
							<h2 align="center">ดูประวัติการโอน</h2>
							...
							<table class="table table-bordered">
								...
								<thead>
									<tr>
										<th class="text-center">ลำดับ</th>
										<th class="text-center">อีเมลล์ผู้รับ</th>
										<th class="text-center">อีเมลล์ผู้ส่ง</th>
										<th class="text-center">จำนวนเงิน</th>
										<th class="text-center">วันที่</th>
									</tr>
								</thead>
								<tbody id="myTable">
									...
									<tr class="text-center">
										...
										<td><%=i + 1%></td>
										<td><%=list1.get(i).getTrEmailmember()%></td>
										<td><%=list1.get(i).getTrEmailuser()%></td>
										<td><%=list1.get(i).getTrEonney()%></td>
										<td><%=list1.get(i).getTrDate()%></td>
						...
						$(document).ready(
							...
							function toggle1() {
								var ds1 = document.getElementById("display1");
							...
							function toggle2() {
								var ds2 = document.getElementById("display2");
